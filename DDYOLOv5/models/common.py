...
#         self.conv = nn.Conv2d(c1, c1, k, s, autopad(k, p), groups=c1, bias=False)
#         self.conv2=nn.Conv2d(in_channels=c1,out_channels=c2,kernel_size=1,padding=0)
#         self.bn = nn.BatchNorm2d(c2)
#         self.act = nn.SiLU() if act is True else (act if isinstance(act, nn.Module) else nn.Identity())
#
#     def forward(self, x):
#         return self.act(self.bn(self.conv2(self.conv(x))))
